...
public static class Routes
{
    public static RouteTable Build() => RouteTable.Empty
        ...
        .Get("/verify-email", AuthHandlers.VerifyEmail)
        .Post("/verify-email/resend", AuthHandlers.ResendVerification)
        ...
        .Get("/admin/settings", Auth.RequirePermission<Manage>(new SettingsResource(), AdminSettingsHandlers.Show))
        .Post("/admin/settings", Auth.RequirePermission<Manage>(new SettingsResource(), AdminSettingsHandlers.Save))
        .Post("/admin/settings/test-email", Auth.RequirePermission<Manage>(new SettingsResource(), AdminSettingsHandlers.TestEmail))
