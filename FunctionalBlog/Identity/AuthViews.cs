...
public static class AuthViews
{
    ...
    {
        var fields =
            Html.Label(Html.Encode(t("auth.register.display_name")) + Html.Input("displayName", displayName)) +
            Html.Label(Html.Encode(t("auth.register.email")) + Html.InputEmail("email", email)) +
            Html.Label(Html.Encode(t("auth.register.password")) + Html.InputPassword("password")) +
            Html.Label(Html.Encode(t("auth.register.confirm_password")) + Html.InputPassword("confirmation")) +
    ...
    {
        var fields =
            Html.Label(Html.Encode(t("auth.reset.email")) + Html.InputEmail("email")) +
    ...
    public static string PasswordResetConfirmForm(IReadOnlyList<string> errors, string token, IPrincipal principal, Translate t)
    {
        var fields =
            ...
            Html.Label(Html.Encode(t("auth.reset_confirm.new_password")) + Html.InputPassword("password")) +
            Html.Label(Html.Encode(t("auth.reset_confirm.confirm_password")) + Html.InputPassword("confirmation")) +
